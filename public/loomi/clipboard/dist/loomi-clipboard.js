 ...
 */
let LoomiClipboard = class LoomiClipboard extends LoomiElement {
    constructor() {
        super(...arguments);
...
__decorate([
    property()
], LoomiClipboard.prototype, "value", void 0);
__decorate([
    property({ attribute: "copy-label" })
], LoomiClipboard.prototype, "copyLabel", void 0);
__decorate([
    property({ attribute: "copied-label" })
], LoomiClipboard.prototype, "copiedLabel", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], LoomiClipboard.prototype, "disabled", void 0);
__decorate([
    state()
], LoomiClipboard.prototype, "status", void 0);
__decorate([
    query("slot")
], LoomiClipboard.prototype, "defaultSlot", void 0);
LoomiClipboard = __decorate([
    customElement("loomi-clipboard")
], LoomiClipboard);
export { LoomiClipboard };
//# sourceMappingURL=loomi-clipboard.js.map