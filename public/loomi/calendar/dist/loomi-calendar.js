...
let LoomiCalendar = class LoomiCalendar extends LoomiElement {
  ...
  `); }
    ...
    isTypingTarget(target) {
        ...
        return Boolean(target.closest("input, textarea, select, loomi-input, loomi-textarea, loomi-tag-input, loomi-select, loomi-datepicker, loomi-timepicker, [contenteditable='true']"));
    }
    openDayView(date) {
