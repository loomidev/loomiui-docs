 ...
 */
let LoomiFilepicker = class LoomiFilepicker extends LitElement {
    constructor() {
        super(...arguments);
        ...
        this.placeholderLine1 = "Choose files or drag and drop to upload";
        this.placeholderLine2 = "%s up to %s";
        this.maxFiles = 1;
